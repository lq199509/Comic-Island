...
export default {
  data() {
    return {
      classifyType: [
        { id: "warmBlood", name: "热血", href: "/classify/warmBlood" },
        { id: "love", name: "恋爱", href: "/classify/love" },
        { id: "funy", name: "搞笑", href: "/classify/funy" },
        { id: "magic", name: "魔幻", href: "/classify/magic" },
        { id: "suspense", name: "悬疑", href: "/classify/suspense" },
        { id: "son", name: "少儿", href: "/classify/son" }
      ],
      curType: this.$route.path.substring(10)
    };
  },
  methods: {
    changeType(item) {
